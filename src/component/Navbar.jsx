...
const Navbar = () => {
    ...
    d="M87.6 52c0 2.1-1.7 3.7-3.7 3.7H3.7C1.7 55.8 0 54.1 0 52V3.7C0 1.7 1.7 0 3.7 0h80.1c2.1 0 3.7 1.7 3.7 3.7V52z"
     ...
     <ul className="lg:flex hidden gap-7 font-semibold cursor-pointer">
      ...
      {isMobileNav && (
        <nav className="lg:hidden flex absolute right-0 top-0 h-screen  bg-white w-[100%] p-6">
          <ul className="space-y-4 font-bold cursor-pointer text-2xl">
            <li className="flex items-center gap-1 hover:text-[#00a2ff]">
              Product
            </li>
            <li className="hover:text-[#00a2ff]">Pricing</li>
